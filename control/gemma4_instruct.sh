...
#SBATCH --output=slurm_log/Gemma_4_No_Think/%x_%j.out  # Output file for job logs %x for job-name and %j for job-id
#SBATCH --container-name=vllm_qwen3.5
#SBATCH --gres=gpu:1
#SBATCH --job-name=Gemma4
...
python3 -u control/gemma4_intruct.py --data_dir=$DATAPATH
