...
def send_batch(batch_messages: list, server_url: str, model_name: str, thinking_tokens: int) -> list[dict]:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gemma4 Thinking — batch server inference")
    parser.add_argument("--data_dir",        type=str, required=True,
                        help="Path to dataset root")
    parser.add_argument("--results_dir",     type=str,
                        default="control/results/gemma4_thinking",
            ...
            for j in range(args.n_runs):
                ...
                for i in range(0, len(png_images), args.chunk_size):
                    ...
                    responses = send_batch(
                        ...
                        thinking_tokens=args.thinking_budget
                    )
