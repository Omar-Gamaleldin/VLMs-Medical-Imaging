...
def make_model_call(model, questions_data, image, tokenizer, additional_question):
    """
...
if __name__ == "__main__":
    ...
    RESULTS_ROOT = 'results/med-gemma'  # path for results directory
            ...
            for i in range(3):  # how many runs ?
                ...
                for image in png_images:
                    ...
                    results_call = make_model_call(
                        model, question_data[0], rgb_image,tokenizer,
